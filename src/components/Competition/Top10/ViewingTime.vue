...
export default {
    ...
    data() {
        return {
            ...
            fields: [
                ...
                {key: 'custom2', label: 'View time', sortable: true},
                {key: 'devices', label: 'Number of devices', sortable: true},
    ...
    methods: {
        ...
        onDisqualifiedUser() {
            console.log('User has been disqualified'); /* eslint-disable-line */
        },
        onAddedUserInBlacklist() {
            console.log('User has been added in blacklist'); /* eslint-disable-line */
        },
        getTime(val) {
